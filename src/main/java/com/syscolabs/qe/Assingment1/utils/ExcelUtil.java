...
import com.syscolabs.qe.Assingment1.data.LoginData;
...
public class ExcelUtil {
    ...
    public static LoginData getLoginData(String key) {
        Object loginObject = ReadExcel.getDataFromExcelSheet(key, System.getProperty("user.dir") + "/src/main/resources/testData/LoginTestData.xls", 0, LoginData.class);
