package com.syscolabs.qe.Assingment1.pages.ageValidation;
...
public class AgeValidationPage extends PageBase {
    ...
    public boolean isEnterButtonDisplayed() {
        return syscoLabUIOgm.isDisplayed(btnEnter);
    }
    public boolean isEnterButtonClickable() {
        return syscoLabUIOgm.isClickable(btnEnter);
    }
    public boolean isCheckBoxDisplayed() {
        return syscoLabUIOgm.isDisplayed(cbRememberMe);
    }
